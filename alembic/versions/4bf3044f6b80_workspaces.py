...
def upgrade() -> None:
    ...
    op.create_table('users',
        ...
        sa.Column('status', sa.Enum('OFFLINE', 'WORKING', 'PAUSED', name='user_status', create_type=False), nullable=False),
        sa.Column('role', sa.Enum('USER', 'ADMIN', 'SUPERADMIN', name='user_role', create_type=False), nullable=False),
    ...
    op.create_table('work_sessions',
        ...
        sa.Column('status', sa.Enum('ACTIVE', 'PAUSED', 'COMPLETED', name='session_status', create_type=False), nullable=False),
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
        sa.Column('id', sa.BigInteger(), autoincrement=True, nullable=False),
